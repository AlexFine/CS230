...
y_hat = tf.constant(None, name='y_hat')            # Define y_hat constant. Set to 36.
y = tf.constant(None, name='y')                    # Define y. Set to 39

#Least Squared Loss Function
loss = tf.Variable(((y - y_hat)**2)*np.exp(sigmoid(y_hat)*y - y_hat), name='loss')  # Create a variable for the customized loss
...
# Loading the dataset
# Handle all data loading in load_dataset()
...
def initialize_parameters(n_x):
    """
    Initialize Network. Keep shallow to start.
